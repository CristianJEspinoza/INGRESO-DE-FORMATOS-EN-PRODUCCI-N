...
@registro_monitoreo_insectos.route('/download_formato', methods=['GET'])
def download_formato():

    # Obtener el id del trabajador de los argumentos de la URL
    id_formato=request.args.get('id_formato') # Por el momento cumple para todos los reportes
    mes=request.args.get('mes')
    print(id_formato, mes)
    cabecera=get_cabecera_formato("registros_monitores_insectos_roedores", id_formato)
    print(cabecera)
    # Realizar la consulta para todos los registros para el monitoreo de insectos
    ...
    # REGISTRO Y MONITOREO DE INSECTOS
    """ Example info
    info [
        {
            "fecha": "01/09/2023",
    ...
    template = render_template(
        "reports/reporte_registro_monitoreo_insectos.html",
        title_manual=POES,
